...
export default function QuotesCard() {
  ...
  return (
    <div className="relative flex flex-col items-center justify-between w-96 h-full gap-8 p-4 rounded-3xl bg-faded-purple-600 pt-16 mt-20">
        <div className="absolute flex rounded-full w-40 h-40 -top-20 bg-faded-purple-600">
            <img className=" object-cover w-32 h-32 rounded-full m-auto" src={quote.img} alt=""/>
        </div>
