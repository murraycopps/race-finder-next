...
export default function QuotesCard() {
  ...
  return (
    <div className="relative flex flex-col items-center justify-between w-full h-full gap-8 p-4 rounded-3xl bg-faded-purple-600">
      <img className="absolute object-cover w-32 h-32 rounded-full" src={quote.img} alt=""/>
